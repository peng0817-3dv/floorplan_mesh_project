...
right_type = ['正确']
'''
this file is used to store the function to clean the dataset by the clean record csv file
and the csv file is generated by human annotators, which then can be used to judge whether the scene is clean or not.
'''
